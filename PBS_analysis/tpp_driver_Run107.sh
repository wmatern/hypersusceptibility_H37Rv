...
FASTQ_DIR=/run/media/will/phd_data1/2018-06-17_Mtb_PBS/Run107/raw
OUT_DIR=/run/media/will/phd_data1/2018-06-17_Mtb_PBS/2018-09-15_TPP_Run107
...
basename -a $OUT_DIR/*.wig | cut -c-13 | uniq > $PREFIXES_OUTFILE #TPP Settings
PRIMER=AACCTGTTA
MISMATCHES=2
WINDOW_SIZE=6
#BWA_ALG="mem"
